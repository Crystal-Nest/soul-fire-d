...
public final class FireBuilder {
  ...
  public Fire build() throws IllegalStateException {
    if (FireManager.isValidFireId(fireId) && FireManager.isValidModId(modId)) {
      ...
      return new Fire(fireType, damage, invertHealAndHarm, inFireGetter, onFireGetter, get(source), get(campfire), register(fireAspectConfigurator, () -> new FireAspectBuilder(fireType)), register(flameConfigurator, () -> new FlameBuilder(fireType)));
    }
